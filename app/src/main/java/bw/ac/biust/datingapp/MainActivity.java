...
public class MainActivity extends AppCompatActivity {
    ...
    public void toLocation(View view) {
        ...
        Intent intent= new Intent(MainActivity.this, LocationPreferences.class);
        startActivity(intent);
    }

    public void toAgePreference(View view) {
        Intent intent= new Intent(MainActivity.this, AgePreferences.class);
        startActivity(intent);
    }

    public void toSameSexPreference(View view) {
        Intent intent= new Intent(MainActivity.this, SameGenderPreference.class);
        startActivity(intent);
    }
}